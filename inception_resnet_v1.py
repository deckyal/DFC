...
def inference(inputs,keep_probability, phase_train=True, 
              bottleneck_layer_size=128, weight_decay=0.0, reuse=None,fourChannel = False):
    batch_norm_params = {
    ...
    with slim.arg_scope([slim.conv2d, slim.fully_connected],
        ...
        return inception_resnet_v1(inputs, is_training=phase_train,
              dropout_keep_prob=keep_probability, bottleneck_layer_size=bottleneck_layer_size, reuse=reuse,fourChannel = fourChannel)


def inception_resnet_v1(inputs,is_training=True,
                        dropout_keep_prob=0.8,
                        bottleneck_layer_size=128,
                        reuse=None, fourChannel = False,
